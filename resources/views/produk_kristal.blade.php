...
@section('content')
<!-- Page Title Start -->
<section class="bgkristal">
    <div class="containerkristal">
        <img class="gmbrbgrrelasi" src="{{ url ('assets/images/index5/eskristalbg.png') }}" alt="eskristalbg"/>
        <div class="contentjudul">
            <img src="{{ url ('assets/images/index5/judulkristal.png') }}">
        </div>
    </div>
</section>
<!-- About Start -->
            ...
            <div class="col-lg-4 col-md-4 d-flex align-items-stretch">
                <div class="kontenp">
                  <div class="kontenp-img">
                    <img src="{{ url ('assets/images/index5/es.png') }}">
                  </div>
                  <div class="kontenp-info">
                    <h4>{{__('bahasa.es kristal10')}}</h4>
                  </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 d-flex align-items-stretch">
                <div class="kontenp">
                  <div class="kontenp-img">
                    <img src="{{ url ('assets/images/index5/es1.png') }}">
                  </div>
                  <div class="kontenp-info">
                    <h4>{{__('bahasa.es kristal5')}}</h4>
                  </div>
                </div>
            </div>
        </div>
        <div class="row justify-content-center" style="margin-top: 1%">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-flex align-items-center mb_30" style="text-align: center;">
                <div class="loc_about_text">
                    <h4 class="loc_sub_heading1 relative">{{__('bahasa.es kristal')}}</h4>
                    <p>{{__('bahasa.deskristal1')}}</p>
                    <p>{{__('bahasa.deskristal2')}}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="swiper-wrapper">
                ...
                <div class="container">
                    <div class="row justify-content-center" style="margin-top: 4%;">
                        <div class="col-lg-3 col-md-12 col-sm-12 col-12 text-center">
                            <img class="parallax_menu" src="{{url('assets/images/index5/prosesk1.png')}}"  width="60%"/>
                        </div>
                        <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                            <p class="pp-p">{{__('bahasa.produkk11')}}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="container">
                    <div class="row justify-content-center" style="margin-top: 4%;">
                        <div class="col-lg-3 col-md-12 col-sm-12 col-12 text-center">
                            <img class="parallax_menu" src="{{url('assets/images/index5/prosesk2.png')}}"  width="60%"/>
                        </div>
                        <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                            <p class="pp-p">{{__('bahasa.produkk21')}}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="container">
                    <div class="row justify-content-center" style="margin-top: 4%;">
                        <div class="col-lg-3 col-md-12 col-sm-12 col-12 text-center">
                            <img class="parallax_menu" src="{{url('assets/images/index5/prosesk3.png')}}"  width="60%"/>
                        </div>
                        <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                            <p class="pp-p">{{__('bahasa.produkk31')}}</p>
                        </div>
                    </div>
                </div>
            </div>
